...
![](./images/maqueen_calibracion.png)
...
![](./images/maqueen_linea-maniobra.png)
...
(A día de hoy, 14/3/22 la extensión de maqueen no da la medida del sensor de ultrasonidos en cm, sino en milisegundos)
Podemos convertir el tiempo en en milisegundos a cm dividiendo por 29 (debería ser dividendo por 2*29):
...
![](./images/maqueen_ultrasonidos_chart.png)

[maqueen - Ultrasonidos 1](https://makecode.microbit.org/_iwR19TFHm5xU)

Ahora vamos a hacer que en función de la distancia se enciendan los leds de maqueen

![](./images/maqueen_ultrasonido_leds.png)

![](./images/maqueen_ultrasonido_led_plots.png)

[maqueen - ultrasonidos - leds](https://makecode.microbit.org/_Rqw3zY1dq9wr)
